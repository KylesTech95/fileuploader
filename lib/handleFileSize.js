const scrollparent = document.getElementById('scroll-v')
...
export function handleFileSize(){
    if(mytarget){
        console.log(mytarget);
    }
}
// mousedown function on scrolltab
window.onmousedown = e => {
    ...
    if(mytarget){
        ...
        window.onmousemove = moveMyTarget // mouse move event
    }
}

function moveMyTarget(e){
